...
import { removeAdmin } from "../../feautures/adminSlice";
      ...
      <div className="relative">
        ...
        >
          ...
          <button
            ...
            className="flex items-center gap-3.5 py-2 px-2 text-sm font-medium duration-300 ease-in-out hover:text-primary lg:text-base"
          >
            <svg
