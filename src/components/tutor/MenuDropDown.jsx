...
import { removeTutor } from "../../feautures/tutorSlice";
...
export default function MenuDropDown({ user }) {
    ...
    return (
      <div className="top-16 w-56 text-right nexa-font">
        <Menu as="div" className="relative inline-block text-left bg-amber-500 rounded-lg">
          <div>
            <Menu.Button className="inline-flex capitalize w-full justify-center rounded-md bg-amber-500 bg-opacity px-2 py-2 text-sm font-medium text-white hover:bg-opacity-90 focus:outline-none focus-visible:ring-2 focus-visible:ring-white  focus-visible:ring-opacity-75">
