import { ChartBarIcon, FolderPlusIcon, PresentationChartBarIcon, QuestionMarkCircleIcon } from "@heroicons/react/24/outline";
...
const features = [
    ...
    },
    {
      name: "Global Reach",
      description:
        "You can connect with learners from around the world and make a positive impact on their lives.",
      icon: ChartBarIcon,
    },
    {
  ...
  export default function TutorAdvantages() {
    return (
      <>
        <SectionTitle
          title="Why Here?"
          description="Empower Your Teaching  with Brain Booster."
          tutor
        />
        <HorizontalRule />
        <div className="bg-white mb-3 rounded-xl py-6 sm:py-20">
          <div className="mx-auto max-w-7xl px-6 lg:px-8">
            <div className="mx-auto max-w-2xl lg:text-center">
              <h2 className="text-xs sm:text-base font-semibold leading-7 text-center text-amber-600">
                Create and Share Your Expertise
              </h2>
                ...
                {features.map((feature) => (
                  <div key={feature.name} className="relative pl-16">
                    <dt className="text-base font-semibold leading-7 text-gray-900">
                      <div className="absolute left-0 top-0 flex h-10 w-1- items-center justify-center rounded-lg bg-amber-600">
                        <feature.icon
